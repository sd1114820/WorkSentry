...
type Querier interface {
	...
	ListAuditLogsByRange(ctx context.Context, arg ListAuditLogsByRangeParams) ([]AuditLog, error)
	...
	ListDailyStatsForRankByDate(ctx context.Context, statDate time.Time) ([]ListDailyStatsForRankByDateRow, error)
